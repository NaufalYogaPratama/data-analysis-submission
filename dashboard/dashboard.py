...
season_options = day_df['season'].unique().tolist()
...
sns.barplot(x=filtered_df['season'], y=filtered_df['cnt'], errorbar=None, estimator='mean', hue=filtered_df['season'], palette=["#B3D7AE", "#B3D7AE", "#44935B", "#B3D7AE"], legend=False, ax=ax1)
...
sns.barplot(x=filtered_df['workingday'], y=filtered_df['cnt'], errorbar=None, estimator='mean', hue=filtered_df['workingday'], palette='Greens', legend=False, ax=ax2)
ax2.set_xlabel("Hari")
...
sns.barplot(x=filtered_df['weathersit'], y=filtered_df['cnt'], errorbar=None, estimator='mean', hue=filtered_df['weathersit'], palette=["#44935B", "#B3D7AE", "#B3D7AE"], legend=False, ax=ax3)
...
ax4.plot(filtered_df['dteday'], filtered_df['cnt'], color='#44935B', label='Jumlah Penyewaan Harian')
